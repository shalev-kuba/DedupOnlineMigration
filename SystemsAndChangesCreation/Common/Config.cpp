...
namespace Config{
    ...
    {
        const uint32_t HEADER_EXPECTED_SIZE = 12;
    }

    namespace FS_HEADER
    {
        const uint32_t HEADER_EXPECTED_SIZE=14;
        ...
        const uint32_t GEN_LEVEL_INDEX = 13;
    }
    ...
    namespace BLOCK_LINE
    {
        ...
        const uint32_t NUM_FILES_INDEX = 3;
        const uint32_t MIN_NUM_ELEMENT_IN_BLOCK_LINE = 4;
    }

    namespace FILE_LINE
    {
        const uint32_t SN_INDEX = 1;
        const uint32_t ID_INDEX = 2;
        const uint32_t PARENT_SN_INDEX = 3;
